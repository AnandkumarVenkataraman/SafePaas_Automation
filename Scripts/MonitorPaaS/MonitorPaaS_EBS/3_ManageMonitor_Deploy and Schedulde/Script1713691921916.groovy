...
WebUI.setText(findTestObject('Object Repository/MonitorPaaS/Rough/Page_Login/input_Spring 2024_P101_COMPANY'), 'KAT')

WebUI.setText(findTestObject('Object Repository/MonitorPaaS/Rough/Page_Login/input_OR CONTINUE WITH_P101_USERNAME'), 'KATALON_ADMIN')

WebUI.setEncryptedText(findTestObject('Object Repository/MonitorPaaS/Rough/Page_Login/input_New_P101_PASSWORD'), 'Ioqy8emDrxi5mkiNQATzxQ==')

WebUI.click(findTestObject('Object Repository/MonitorPaaS/Rough/Page_Login/button_Login'))

WebUI.verifyElementClickable(findTestObject('Object Repository/MonitorPaaS/Rough/Page_Home/span_AccessPaaS_a-TreeView-toggle'))

WebUI.click(findTestObject('Object Repository/MonitorPaaS/Rough/Page_Home/span_AccessPaaS_a-TreeView-toggle'))

WebUI.verifyElementClickable(findTestObject('Object Repository/MonitorPaaS/Rough/Page_Home/a_Manage Monitors'))

WebUI.click(findTestObject('Object Repository/MonitorPaaS/Rough/Page_Home/a_Manage Monitors'))

WebUI.verifyElementClickable(findTestObject('Object Repository/MonitorPaaS/Rough/Page_Manage Monitors/select_Select any OneWorkDay_Env_ObjSetTrir_ff6b0a'))

WebUI.selectOptionByLabel(findTestObject('Object Repository/MonitorPaaS/Rough/Page_Manage Monitors/select_Select any OneWorkDay_Env_ObjSetTrir_ff6b0a'), 
    'KTLNEBS_MonitorPaaS_ObjSet', true, FailureHandling.OPTIONAL)

WebUI.delay(3)

WebUI.verifyElementClickable(findTestObject('Object Repository/MonitorPaaS/Rough/Page_Manage Monitors/button_Deploy'))

WebUI.click(findTestObject('Object Repository/MonitorPaaS/Rough/Page_Manage Monitors/button_Deploy'))
...
WebUI.verifyElementClickable(findTestObject('Object Repository/MonitorPaaS/Rough/Page_Manage Monitors/button_Monitor Created Successfully_t-Butto_4161d3'))

WebUI.click(findTestObject('Object Repository/MonitorPaaS/Rough/Page_Manage Monitors/button_Monitor Created Successfully_t-Butto_4161d3'))

WebUI.verifyElementClickable(findTestObject('Object Repository/MonitorPaaS/Rough/Page_Manage Monitors/a_AR Approval Limits'))

WebUI.click(findTestObject('Object Repository/MonitorPaaS/Rough/Page_Manage Monitors/a_AR Approval Limits'))
...
WebUI.verifyElementClickable(findTestObject('Object Repository/MonitorPaaS/Rough/Page_Monitor Details/span_People'))

WebUI.click(findTestObject('Object Repository/MonitorPaaS/Rough/Page_Monitor Details/span_People'))
...
WebUI.verifyElementClickable(findTestObject('Object Repository/MonitorPaaS/MonitorPaaS_Deploy/Page_Job Detail/label_Occurrences'))

WebUI.click(findTestObject('Object Repository/MonitorPaaS/MonitorPaaS_Deploy/Page_Job Detail/label_Occurrences'))
...
WebUI.selectOptionByLabel(findTestObject('Object Repository/MonitorPaaS/MonitorPaaS_Deploy/Page_Job Detail/select_-- Select any one ---- Local File --_fe0110'), 
    'KTLNEBS_MonitorPaaS_Vision122_DS', true, FailureHandling.OPTIONAL)

WebUI.delay(0)

WebUI.verifyElementClickable(findTestObject('Object Repository/MonitorPaaS/MonitorPaaS_Deploy/Page_Job Detail/option_AR Approval Limits'))

WebUI.click(findTestObject('Object Repository/MonitorPaaS/MonitorPaaS_Deploy/Page_Job Detail/option_AR Approval Limits'))
...
WebUI.verifyElementClickable(findTestObject('MonitorPaaS/MonitorPaaS_Deploy/Page_Manage Result Set/span_Setup_a-TreeView-toggle - UR31'))

WebUI.click(findTestObject('MonitorPaaS/MonitorPaaS_Deploy/Page_Manage Result Set/span_Setup_a-TreeView-toggle - UR31'))

WebUI.verifyElementClickable(findTestObject('MonitorPaaS/MonitorPaaS_Deploy/Page_Manage Result Set/a_Manage Snapshot - UR33'))

WebUI.click(findTestObject('MonitorPaaS/MonitorPaaS_Deploy/Page_Manage Result Set/a_Manage Snapshot - UR33'))
...
WebUI.verifyElementClickable(findTestObject('Object Repository/MonitorPaaS/ManageMonitor_Snapshot/Page_Manage Snapshot/a_(SS)KTLN_ARAPRLMT_APR19_V1_20240419023818'))

WebUI.click(findTestObject('Object Repository/MonitorPaaS/ManageMonitor_Snapshot/Page_Manage Snapshot/a_(SS)KTLN_ARAPRLMT_APR19_V1_20240419023818'))

WebUI.verifyElementClickable(findTestObject('Object Repository/MonitorPaaS/ManageMonitor_Snapshot/Page_AddEdit Snapshot/span_Snapshot Details'))

WebUI.click(findTestObject('Object Repository/MonitorPaaS/ManageMonitor_Snapshot/Page_AddEdit Snapshot/span_Snapshot Details'))

WebUI.verifyElementClickable(findTestObject('Object Repository/MonitorPaaS/ManageMonitor_Snapshot/Page_Snapshot Details/select_Select any oneAR Approval Limits'))

WebUI.selectOptionByLabel(findTestObject('Object Repository/MonitorPaaS/ManageMonitor_Snapshot/Page_Snapshot Details/select_Select any oneAR Approval Limits'), 
    'AR Approval Limits', true, FailureHandling.OPTIONAL)
...
WebUI.verifyElementClickable(findTestObject('Object Repository/MonitorPaaS/ManageMonitor_Snapshot/Page_Snapshot Details/span_Manage Snapshot'))

WebUI.click(findTestObject('Object Repository/MonitorPaaS/ManageMonitor_Snapshot/Page_Snapshot Details/span_Manage Snapshot'))

WebUI.verifyElementClickable(findTestObject('Object Repository/MonitorPaaS/ManageMonitor_Snapshot/Page_AddEdit Snapshot/button_Cancel'))

WebUI.click(findTestObject('Object Repository/MonitorPaaS/ManageMonitor_Snapshot/Page_AddEdit Snapshot/button_Cancel'))
