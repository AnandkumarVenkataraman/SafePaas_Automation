...
WebUI.verifyElementClickable(findTestObject('Object Repository/EACM/EACM_ManageWorkflow/Page_Manage Workflow/button_Search'))

WebUI.click(findTestObject('Object Repository/EACM/EACM_ManageWorkflow/Page_Manage Workflow/button_Search'))
...
WebUI.setText(findTestObject('Object Repository/EACM/EACM_ManageWorkflow/Page_Manage Workflow/input_p_ignore_10'), 'KTLN_EACM_Survey_Feb18_V2')
...
WebUI.setText(findTestObject('Object Repository/EACM/EACM_ManageWorkflow/Page_Manage Workflow/textarea_P35_ACTION_COMMENTS'), 
    'Cancel for KTLN_EACM_Survey_Feb18_V2')
