...
WebUI.setText(findTestObject('Object Repository/deba/Rough/EACM_AutomaticPOST/Page_Login/input_P101_COMPANY'), 'KAT')

WebUI.setText(findTestObject('Object Repository/deba/Rough/EACM_AutomaticPOST/Page_Login/input_P101_USERNAME'), 'KTLN_EACM_USER1')

WebUI.setEncryptedText(findTestObject('Object Repository/deba/Rough/EACM_AutomaticPOST/Page_Login/input_P101_PASSWORD'), 
    'Ioqy8emDrxi5mkiNQATzxQ==')

WebUI.click(findTestObject('Object Repository/deba/Rough/EACM_AutomaticPOST/Page_Login/button_Login'))
...
WebUI.verifyElementClickable(findTestObject('Object Repository/deba/Rough/EACM_AutomaticPOST/Page_Manage Certification/select_Select any oneCERP_1CloudERPEBizApp__a9def6'))

WebUI.selectOptionByLabel(findTestObject('Object Repository/deba/Rough/EACM_AutomaticPOST/Page_Manage Certification/select_Select any oneCERP_1CloudERPEBizApp__a9def6'), 
    'KTLN_CloudERP_EACM', true, FailureHandling.OPTIONAL)

WebUI.verifyElementClickable(findTestObject('Object Repository/deba/Rough/EACM_AutomaticPOST/Page_Manage Certification/button_Create'))

WebUI.click(findTestObject('Object Repository/deba/Rough/EACM_AutomaticPOST/Page_Manage Certification/button_Create'))

WebUI.verifyElementText(findTestObject('Object Repository/deba/Rough/EACM_AutomaticPOST/Page_Initiate User Access/input_P10_NAME'), 
    '')
...
WebUI.click(findTestObject('Object Repository/deba/Rough/EACM_AutomaticPOST/Page_Initiate User Access/button_Popup Calendar End Date'))

WebUI.verifyElementClickable(findTestObject('Object Repository/deba/Rough/EACM_AutomaticPOST/Page_Initiate User Access/a_10'))

WebUI.click(findTestObject('Object Repository/deba/Rough/EACM_AutomaticPOST/Page_Initiate User Access/a_10'))
...
WebUI.verifyElementClickable(findTestObject('Object Repository/deba/Rough/EACM_AutomaticPOST/Page_Initiate User Access/label_Verified'))

WebUI.click(findTestObject('Object Repository/deba/Rough/EACM_AutomaticPOST/Page_Initiate User Access/label_Verified'))

WebUI.verifyElementClickable(findTestObject('Object Repository/deba/Rough/EACM_AutomaticPOST/Page_Initiate User Access/label_Automatic POST'))

WebUI.click(findTestObject('Object Repository/deba/Rough/EACM_AutomaticPOST/Page_Initiate User Access/label_Automatic POST'))

WebUI.takeFullPageScreenshot()

WebUI.scrollToElement(findTestObject('Object Repository/deba/Rough/EACM_AutomaticPOST/Page_Initiate User Access/span_a-Icon icon-up-chevron'), 
    0)

WebUI.verifyElementClickable(findTestObject('Object Repository/deba/Rough/EACM_AutomaticPOST/Page_Initiate User Access/span_a-Icon icon-up-chevron'))

WebUI.click(findTestObject('Object Repository/deba/Rough/EACM_AutomaticPOST/Page_Initiate User Access/span_a-Icon icon-up-chevron'))

WebUI.verifyElementClickable(findTestObject('Object Repository/deba/Rough/EACM_AutomaticPOST/Page_Initiate User Access/button_Create'))

WebUI.click(findTestObject('Object Repository/deba/Rough/EACM_AutomaticPOST/Page_Initiate User Access/button_Create'))
