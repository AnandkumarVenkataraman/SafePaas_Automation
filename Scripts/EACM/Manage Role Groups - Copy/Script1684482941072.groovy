...
WebUI.setEncryptedText(findTestObject('Object Repository/Manage Role Groups/input_New_P101_PASSWORD'), '03lOr3vXk3RRBmreyIGpTg==')

WebUI.click(findTestObject('Object Repository/Manage Role Groups/button_Login'))

WebUI.click(findTestObject('Object Repository/Manage Role Groups/span_Help_a-TreeView-toggle'))

WebUI.click(findTestObject('Object Repository/Manage Role Groups/span_Enterprise Access Monitor_a-TreeView-toggle'))

WebUI.click(findTestObject('Object Repository/Manage Role Groups/span_Access Certification_a-TreeView-toggle'))
...
WebUI.selectOptionByLabel(findTestObject('Object Repository/Manage Role Groups/select_Select any oneCloudERPEBizApp_JDBC_E_6b6150'), 
    'SailPoint_ENV2', true, FailureHandling.OPTIONAL)
