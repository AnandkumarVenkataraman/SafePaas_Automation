...
WebUI.setText(findTestObject('Object Repository/EACM API Objects POST-GET/input_OR CONTINUE WITH_P101_USERNAME'), 'KTLN_EACM_USER1')

WebUI.setEncryptedText(findTestObject('Object Repository/EACM API Objects POST-GET/input_New_P101_PASSWORD'), '03lOr3vXk3RRBmreyIGpTg==')
