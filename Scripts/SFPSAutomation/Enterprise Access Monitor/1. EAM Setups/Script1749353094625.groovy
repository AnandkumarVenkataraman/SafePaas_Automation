...
WebUI.enhancedClick(findTestObject('Object Repository/Anand_SFPSAutomation/Page_Home/span_Roles Manager_a-TreeView-toggle (5)'))
...
WebUI.closeBrowser()
	...
	KeywordUtil.markPassed("EAM Setups")
}