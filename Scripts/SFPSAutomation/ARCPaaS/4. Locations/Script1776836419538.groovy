...
WebUI.setText(findTestObject('Object Repository/ARCPaaS/Page_Manage Locations/input_Manage Locations_R388045219375147697__6286a8'), 
    'Grand Central')

WebUI.enhancedClick(findTestObject('Object Repository/ARCPaaS/Page_Manage Locations/button_Go'))

WebUI.enhancedClick(findTestObject('Object Repository/ARCPaaS/Page_Manage Locations/img_Link_apex-edit-pencil'))

WebUI.enhancedClick(findTestObject('Object Repository/ARCPaaS/Page_Manage Locations/button_Cancel'))

WebUI.enhancedClick(findTestObject('Object Repository/ARCPaaS/Page_Manage Locations/button_Remove Filter'), FailureHandling.OPTIONAL)
