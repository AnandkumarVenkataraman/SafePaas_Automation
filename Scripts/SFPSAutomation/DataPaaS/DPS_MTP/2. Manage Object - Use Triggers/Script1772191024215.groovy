...
//Verify the DataPaaS Monitor for type = MonitorPaaS, and CT Type = 'Use Triggers'
WebUI.delay(2)
...
WebUI.verifyElementText(findTestObject('Object Repository/Anand_SFPSAutomation/Page_AddEdit Object Details/div_Use Triggers'), 
    'Use Triggers')
WebUI.delay(2)
WebUI.takeScreenshot()
