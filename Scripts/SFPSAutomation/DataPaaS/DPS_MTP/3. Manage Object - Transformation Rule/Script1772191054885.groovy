...
//Verify the DataPaaS Monitor for type = MonitorPaaS, CT Type = 'Use Snapshots', and the Transformation Rule
WebUI.delay(2)
...
WebUI.enhancedClick(findTestObject('Object Repository/Anand_SFPSAutomation/Page_Apply Transformation Rule/img_Value 3_apex-edit-page'))
WebUI.delay(20)
WebUI.takeScreenshot()
WebUI.enhancedClick(findTestObject('Object Repository/Anand_SFPSAutomation/Page_Apply Transformation Rule/span_AddEdit Transformation Rule_ui-button-_f48ee0'))
