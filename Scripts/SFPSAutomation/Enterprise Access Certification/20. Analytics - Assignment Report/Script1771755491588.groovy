...
WebUI.click(findTestObject('Object Repository/Anand_SFPSAutomation/Page_Home/span_Help_a-TreeView-toggle (90)'))

WebUI.click(findTestObject('Object Repository/Anand_SFPSAutomation/Page_Home/span_Enterprise Access Monitor_a-TreeView-toggle (13)'))

WebUI.click(findTestObject('Object Repository/Anand_SFPSAutomation/Page_Home/span_Dashboard_a-TreeView-toggle (25)'))

WebUI.click(findTestObject('Object Repository/Anand_SFPSAutomation/Page_Home/a_Assignment Report'))
...
WebUI.click(findTestObject('Object Repository/Anand_SFPSAutomation/Page_Assignment Report/a_Inbox'))

WebUI.click(findTestObject('Object Repository/Anand_SFPSAutomation/Page_Home/button_katadmin (9)'))

WebUI.click(findTestObject('Object Repository/Anand_SFPSAutomation/Page_Home/a_Logout (16)'))
