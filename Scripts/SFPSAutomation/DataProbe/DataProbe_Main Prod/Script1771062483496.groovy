...
WebUI.enhancedClick(findTestObject('Object Repository/Anand_SFPSAutomation/a_User Entry Access Listing'))
WebUI.delay(2)
WebUI.takeScreenshot()

WebUI.enhancedClick(findTestObject('Object Repository/Anand_SFPSAutomation/a_User Entry Attribute Access Listing'))
WebUI.delay(2)
WebUI.takeScreenshot()

WebUI.enhancedClick(findTestObject('Object Repository/Anand_SFPSAutomation/a_Entry Listing'))

WebUI.selectOptionByIndex(findTestObject('Object Repository/Anand_SFPSAutomation/select_Select any oneConcurrent ProgramGran_166b3f'),
	1)
WebUI.delay(2)
WebUI.takeScreenshot()
...
WebUI.enhancedClick(findTestObject('Object Repository/Anand_SFPSAutomation/a_Entry Attributes'))

WebUI.enhancedClick(findTestObject('Object Repository/Anand_SFPSAutomation/button_Entry Type_a-Button a-IRR-button a-B_36387a'), FailureHandling.OPTIONAL)
...
WebUI.enhancedClick(findTestObject('Object Repository/Anand_SFPSAutomation/a_Access Hierarchy'))

WebUI.enhancedClick(findTestObject('Object Repository/Anand_SFPSAutomation/button_Access Type_P13_RESPONSIBILITY_lov_btn'))

WebUI.setText(findTestObject('Object Repository/Anand_SFPSAutomation/input_Search_a-PopupLOV-search apex-item-text'), 'General Ledger Super User')

WebUI.enhancedClick(findTestObject('Object Repository/Anand_SFPSAutomation/button_Search_a-Button a-PopupLOV-doSearch'))

WebUI.enhancedClick(findTestObject('Object Repository/Anand_SFPSAutomation/li_AU General Ledger Super UserAU_GENERAL_L_3f6d89'))

WebUI.enhancedClick(findTestObject('Object Repository/Anand_SFPSAutomation/button_Go (1)'))

WebUI.selectOptionByIndex(findTestObject('Object Repository/Anand_SFPSAutomation/select_Select any oneCoupa_Env1EBizApp_JDBC_e66b03 (1)'),
	0)

WebUI.enhancedClick(findTestObject('Object Repository/Anand_SFPSAutomation/a_Inbox (1)'))

WebUI.enhancedClick(findTestObject('Object Repository/Anand_SFPSAutomation/button_katalon_admin'))

WebUI.enhancedClick(findTestObject('Object Repository/Anand_SFPSAutomation/a_Logout'))
