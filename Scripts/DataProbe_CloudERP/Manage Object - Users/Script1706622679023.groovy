...
String_result = WebUI.getText(findTestObject('Manage Object/a_Users_KTLN'), FailureHandling.CONTINUE_ON_FAILURE)
...
if (String_result == 'Users_KTLN') {
    ...
    WebUI.click(findTestObject('Manage Object/a_Users_KTLN'))
    ...
    String_result3 = WebUI.getText(findTestObject('Object Repository/Other Objects/input_URI_P10_OBJ_CLOUD_URI_Users'))

    WebUI.click(findTestObject('Object Repository/Manage Object - Attributes/Page_AddEdit Object Details/span_Object Items'))

    String_result4 = WebUI.getText(findTestObject('Other Objects/td_FSOD.FSOD_USER_ALL1 - Copy'))

    String_result5 = WebUI.getText(findTestObject('Other Objects/td_FSOD.FSOD_USER_ALL2 - Copy'))

    String_result6 = WebUI.getText(findTestObject('Other Objects/td_FSOD.FSOD_USER_ALL3 - Copy'))

    String_result7 = WebUI.getText(findTestObject('Other Objects/td_FSOD.FSOD_USER_ALL4 - Copy'))

    String_result8 = WebUI.getText(findTestObject('Other Objects/td_FSOD.FSOD_USER_ALL5 - Copy'))

    String_result9 = WebUI.getText(findTestObject('Other Objects/td_FSOD.FSOD_USER_ALL6 - Copy'))

    String_result10 = WebUI.getText(findTestObject('Other Objects/td_FSOD.FSOD_USER_ALL7 - Copy'))
