...
WebUI.verifyElementClickable(findTestObject('Manage Object Set/Page_AddEdit Objectset/td_ENTRY PRIVILEGE'))

WebUI.verifyElementText(findTestObject('Manage Object Set/Page_AddEdit Objectset/td_ENTRY PRIVILEGE'), 'ENTRY')

WebUI.verifyElementClickable(findTestObject('Manage Object Set/Page_AddEdit Objectset/Obj_EntryPrivilege'))
...
WebUI.setText(findTestObject('Object Repository/Upload Data/Page_Manage Snapshot/input_(Value Required)_P37_NAME'), 'EntryPrivilege_KTLN_FEB18_V1')
...
WebUI.click(findTestObject('Upload Data/Page_Snapshot Details/li_EntryPrivileges_KTLN'))
...
WebUI.uploadFile(findTestObject('Upload Data/Page_Manage Snapshot/input_(Value Required)_P37_FILE'), 'C:\\Users\\MARIAISABEL.BRUM\\Desktop\\XML\'s\\EntryPrivilege_KTLN.xml')
