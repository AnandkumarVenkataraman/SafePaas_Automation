...
WebUI.verifyElementClickable(findTestObject('Manage Object Set/Page_AddEdit Objectset/td_ENTRY_ATTRIBUTE'))

WebUI.verifyElementText(findTestObject('Manage Object Set/Page_AddEdit Objectset/td_ENTRY_ATTRIBUTE'), 'ENTRY_ATTRIBUTE')

WebUI.verifyElementClickable(findTestObject('Manage Object Set/Page_AddEdit Objectset/Obj_EntryAttribute'))
...
WebUI.setText(findTestObject('Object Repository/Upload Data/Page_Manage Snapshot/input_(Value Required)_P37_NAME'), 'EntryAttribute_KTLN_FEB18_V1')
...
WebUI.click(findTestObject('Upload Data/Page_Snapshot Details/li_EntryAttribute_KTLN'))
...
WebUI.uploadFile(findTestObject('Upload Data/Page_Manage Snapshot/input_(Value Required)_P37_FILE'), 'C:\\Users\\MARIAISABEL.BRUM\\Desktop\\XML\'s\\EntryAttribute_KTLN.xml')
