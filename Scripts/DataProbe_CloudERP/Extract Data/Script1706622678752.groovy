...
WebUI.setText(findTestObject('Object Repository/Extract Data/input_(Value Required)_P30_SCHEDULER_JOB_NAME'), 'KTLN_Jan30_V1', 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.scrollToElement(findTestObject('Object Repository/Extract DataNew/Page_Job Detail/span_a-Icon icon-up-chevron'), 0)
...
WebUI.verifyElementClickable(findTestObject('Object Repository/Extract DataNew/Page_Manage Snapshot/button_Go (1)'))

WebUI.click(findTestObject('Object Repository/Extract DataNew/Page_Manage Snapshot/button_Go (1)'))
...
WebUI.verifyElementVisible(findTestObject('Object Repository/Extract DataNew/Page_Manage Snapshot/a_Name'), FailureHandling.OPTIONAL)

WebUI.verifyElementVisible(findTestObject('Object Repository/Extract DataNew/Page_Manage Snapshot/a_Last Update Date'), 
