...
WebUI.setText(findTestObject('Object Repository/ANALYTICS1/input_Winter 2023_P101_COMPANY'), 'KAT')

WebUI.setText(findTestObject('Object Repository/ANALYTICS1/input_OR CONTINUE WITH_P101_USERNAME'), 'KATALON_ADMIN')

WebUI.setEncryptedText(findTestObject('Object Repository/ANALYTICS1/input_New_P101_PASSWORD'), 'N3mGwrN6bT8efSdTK/YVUw==')

WebUI.click(findTestObject('Object Repository/ANALYTICS1/button_Login'))
...
WebUI.click(findTestObject('Object Repository/ANALYTICS1/span_Dashboard_a-TreeView-toggle'))

WebUI.click(findTestObject('Object Repository/ANALYTICS1/span_Violation Report_a-TreeView-toggle'))
...
WebUI.click(findTestObject('ANALYTICS1/a_Access Hierarchy1'))
