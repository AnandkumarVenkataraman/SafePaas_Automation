...
String result = WebUI.getText(findTestObject('Object Repository/Other Objects/a_EntryRoles_KTLN'), FailureHandling.CONTINUE_ON_FAILURE)

if (result.equals('EntryRoles_KTLN')) {
    WebUI.click(findTestObject('Object Repository/Other Objects/a_EntryRoles_KTLN'))

    String result1 = WebUI.getText(findTestObject('Object Repository/Manage Object - Attributes/Page_AddEdit Object Details/input_Object Name_P10_OBJECT_NAME'))
