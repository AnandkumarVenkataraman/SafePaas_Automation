...
if (String_result == 'UserEntry_KTLN') {
    ...
    String_result3 = WebUI.getText(findTestObject('Object Repository/Other Objects/input_URI_P10_OBJ_CLOUD_URI_UserEntry'))

    WebUI.click(findTestObject('Object Repository/Manage Object - Attributes/Page_AddEdit Object Details/span_Object Items'))

    String_result4 = WebUI.getText(findTestObject('Object Repository/Other Objects/td_FSOD.FSOD_USER_ENTRY_ALL1'))

    String_result5 = WebUI.getText(findTestObject('Object Repository/Other Objects/td_FSOD.FSOD_USER_ENTRY_ALL2'))

    String_result6 = WebUI.getText(findTestObject('Object Repository/Other Objects/td_FSOD.FSOD_USER_ENTRY_ALL3'))

    String_result7 = WebUI.getText(findTestObject('Object Repository/Other Objects/td_FSOD.FSOD_USER_ENTRY_ALL4'))

    WebUI.click(findTestObject('Object Repository/Other Objects/button_Cancel_UserEntry'))
