...
String_result = WebUI.getText(findTestObject('Manage Object/a_EntryAttribute_KTLN'), FailureHandling.CONTINUE_ON_FAILURE)

System.out.println(String_result)

WebUI.delay(5)

if (String_result == 'EntryAttribute_KTLN') {
    WebUI.delay(3)

    WebUI.click(findTestObject('Manage Object/a_EntryAttribute_KTLN'))
    ...
    String_result3 = WebUI.getText(findTestObject('Object Repository/Other Objects/input_URI_P10_OBJ_CLOUD_URI_EntryAttribute'))

    WebUI.click(findTestObject('Object Repository/Manage Object - Attributes/Page_AddEdit Object Details/span_Object Items'))

    String_result4 = WebUI.getText(findTestObject('Object Repository/Other Objects/td_FSOD.FSOD_ENTRY_ATTRIBUTE_ALL1'))

    String_result5 = WebUI.getText(findTestObject('Object Repository/Other Objects/td_FSOD.FSOD_ENTRY_ATTRIBUTE_ALL2'))

    WebUI.click(findTestObject('Object Repository/Other Objects/button_Cancel_EntryAttribute'))
