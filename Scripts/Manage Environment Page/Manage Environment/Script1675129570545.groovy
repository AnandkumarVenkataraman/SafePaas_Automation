...
WebUI.verifyElementClickable(findTestObject('Manage Company - Users/Page_Home/span_Administration_a-TreeView-toggle'))

WebUI.click(findTestObject('Manage Company - Users/Page_Home/span_Administration_a-TreeView-toggle'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Manage Environment/Page_Home/a_Manage Environment'))
