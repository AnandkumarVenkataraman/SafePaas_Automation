...
String gmailUser = 'alexis.majul@safepaas.com' // CHANGE HERE

String jumpcloudUser = gmailUser

String jumpcloudPassEnc = 'aGTE27ylaTbs56x6Pb3Inw==' // 

String safepaasCompany = 'kat' // COMPANY

String safepaasUser = 'KATADMIN' // SAFEPAASUSER

String safepaasPassEnc = 'Ioqy8emDrxi5mkiNQATzxQ==' // CAMBIAR: password ENCRIPTADO de SafePaaS

// =========================================
// ========= PARTE 1: GMAIL + JUMPCLOUD + USER MANAGE VIOLATION =========
WebUI.openBrowser('')
...
WebUI.setText(findTestObject('Object Repository/ALEXOR/alex/Page_Gmail/input_to continue to Gmail_identifierId'), gmailUser)

WebUI.click(findTestObject('Object Repository/ALEXOR/alex/Page_Gmail/span_Learn more about using Guest mode_VfPp_231d3e'))

WebUI.setText(findTestObject('Object Repository/ALEXOR/alex/Page_JumpCloud User Portal - Login/input_Email_email'), jumpcloudUser)
...
WebUI.setText(findTestObject('Object Repository/ALEXOR/alex/Page_Login/input_Fall 2025_P101_COMPANY'), safepaasCompany)

WebUI.setText(findTestObject('Object Repository/ALEXOR/alex/Page_Login/input_OR CONTINUE WITH_P101_USERNAME'), safepaasUser)

WebUI.setEncryptedText(findTestObject('Object Repository/ALEXOR/alex/Page_Login/input_New_P101_PASSWORD'), safepaasPassEnc)
...
// ========= PARTE 2: CHECK (LOGIN KATADMIN Y NAVEGAR A MANAGE REVIEW ACTIONS) =========
