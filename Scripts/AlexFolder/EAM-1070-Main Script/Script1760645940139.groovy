...
WebUI.click(findTestObject('Object Repository/ALEXOR/alex/Page_Manage EAM Roles/a_Manage Remediation Plan_a-TreeView-label'))
WebUI.click(findTestObject('Object Repository/ALEXOR/alex/Page_Manage Mitigations/button_Mitigation Controls_B303188941954620028'))
