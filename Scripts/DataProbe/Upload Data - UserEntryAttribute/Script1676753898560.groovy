...
WebUI.verifyElementClickable(findTestObject('Manage Object Set/Page_AddEdit Objectset/td_USER_ENTRY_ATTRIBUTE'))

WebUI.verifyElementText(findTestObject('Manage Object Set/Page_AddEdit Objectset/td_USER_ENTRY_ATTRIBUTE'), 'USER_ENTRY_ATTRIBUTE')

WebUI.verifyElementClickable(findTestObject('Manage Object Set/Page_AddEdit Objectset/Obj_UserEntryAttribute'))

WebUI.selectOptionByValue(findTestObject('Manage Object Set/Page_AddEdit Objectset/Obj_UserEntryAttribute'), '349631', true)
...
WebUI.setText(findTestObject('Object Repository/Upload Data/Page_Manage Snapshot/input_(Value Required)_P37_NAME'), 'UserEntryAttribute_KTLN_FEB18_V1')
...
WebUI.click(findTestObject('Upload Data/Page_Snapshot Details/li_UserEntryAttribute_KTLN'))
...
WebUI.uploadFile(findTestObject('Upload Data/Page_Manage Snapshot/input_(Value Required)_P37_FILE'), 'C:\\Users\\MARIAISABEL.BRUM\\Desktop\\XML\'s\\UserEntryAttribute_KTLN.xml')
