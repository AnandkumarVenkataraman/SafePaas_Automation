...
WebUI.verifyElementClickable(findTestObject('Manage Object Set/Page_AddEdit Objectset/td_USER_ENTRY'))

WebUI.verifyElementText(findTestObject('Manage Object Set/Page_AddEdit Objectset/td_USER_ENTRY'), 'USER_ENTRY')

WebUI.verifyElementClickable(findTestObject('Manage Object Set/Page_AddEdit Objectset/Obj_UserEntry'))
...
WebUI.setText(findTestObject('Object Repository/Upload Data/Page_Manage Snapshot/input_(Value Required)_P37_NAME'), 'UserEntry_KTLN_FEB18_V1')
...
WebUI.click(findTestObject('Upload Data/Page_Snapshot Details/li_UserEntry_KTLN'))
...
WebUI.uploadFile(findTestObject('Upload Data/Page_Manage Snapshot/input_(Value Required)_P37_FILE'), 'C:\\Users\\MARIAISABEL.BRUM\\Desktop\\XML\'s\\UserEntry_KTLN.xml')
