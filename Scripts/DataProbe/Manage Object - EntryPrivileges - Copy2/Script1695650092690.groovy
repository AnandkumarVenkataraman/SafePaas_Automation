...
if (String_result == 'EntryPrivileges_KTLN') {
    ...
    String_result3 = WebUI.getText(findTestObject('Object Repository/Other Objects/input_URI_P10_OBJ_CLOUD_URI_EntryPrivileges'))

    WebUI.click(findTestObject('Object Repository/Manage Object - Attributes/Page_AddEdit Object Details/span_Object Items'))

    String_result4 = WebUI.getText(findTestObject('Object Repository/Other Objects/td_FSOD.FSOD_ENTRY_ALL_PRIVILEGE1'))

    String_result5 = WebUI.getText(findTestObject('Object Repository/Other Objects/td_FSOD.FSOD_ENTRY_ALL_PRIVILEGE2'))

    String_result6 = WebUI.getText(findTestObject('Object Repository/Other Objects/td_FSOD.FSOD_ENTRY_ALL_PRIVILEGE3'))

    String_result7 = WebUI.getText(findTestObject('Object Repository/Other Objects/td_FSOD.FSOD_ENTRY_ALL_PRIVILEGE4'))

    String_result8 = WebUI.getText(findTestObject('Object Repository/Other Objects/td_FSOD.FSOD_ENTRY_ALL_PRIVILEGE5'))

    WebUI.click(findTestObject('Object Repository/Other Objects/button_Cancel_EntryPrivilege'))
