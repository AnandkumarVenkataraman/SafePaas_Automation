...
WebUI.setText(findTestObject('Object Repository/Manage Roles/Page_Login/input_Winter 2023_P101_COMPANY'), 'KAT')

WebUI.setText(findTestObject('Object Repository/Manage Roles/Page_Login/input_OR CONTINUE WITH_P101_USERNAME'), 'KATALON_ADMIN')

WebUI.setEncryptedText(findTestObject('Object Repository/Manage Roles/Page_Login/input_New_P101_PASSWORD'), 'E9jDT7RxyN0+jhzlxRmzLQ==')

WebUI.click(findTestObject('Object Repository/Manage Roles/Page_Login/button_Login'))

WebUI.click(findTestObject('Object Repository/Manage Roles/Page_Home/span_MonitorPaaS_a-TreeView-toggle'))

WebUI.click(findTestObject('Object Repository/Manage Roles/Page_Home/span_Manage Snapshot_a-TreeView-toggle'))

WebUI.verifyElementClickable(findTestObject('Object Repository/Manage Roles/Page_Home/a_Manage Roles'))

WebUI.click(findTestObject('Object Repository/Manage Roles/Page_Home/a_Manage Roles'))
...
WebUI.click(findTestObject('Manage Roles/a_Manage Roles1'))
