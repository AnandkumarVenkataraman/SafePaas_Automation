...
WebUI.click(findTestObject('Manage Data Source/a_Manage Data Source2'))
...
WebUI.click(findTestObject('Manage Data Source/input_Create_R119140564844328612_search_field - Copy'))

WebUI.setText(findTestObject('Manage Data Source/input_Create_R119140564844328612_search_field - Copy'), 'KTLN_Dev22')
...
String_result1 = WebUI.getText(findTestObject('Object Repository/Manage Data Source/a_KTLN_Dev22'), FailureHandling.CONTINUE_ON_FAILURE)

System.out.println(String_result1)

WebUI.delay(3)

if (String_result1 == 'KTLN_Dev22') {
    WebUI.delay(3)

    WebUI.click(findTestObject('Object Repository/Manage Data Source/a_KTLN_Dev22'))

    String_result2 = WebUI.getText(findTestObject('Object Repository/Manage Data Source/span_Yes'))

    String_result3 = WebUI.getText(findTestObject('Object Repository/Manage Data Source/input_(Value Required)_P4_DS_NAME'))

    String_result4 = WebUI.getText(findTestObject('Object Repository/Manage Data Source/select_- Select Any -DB2Local FilesOracleOracle Cloud RESTOracle Cloud SOAPOracle SQL SOAPRemote FilesSqlServer'))

    String_result5 = WebUI.getText(findTestObject('Object Repository/Manage Data Source/input_(Value Required)_P4_DS_HOSTNAME'))

    String_result6 = WebUI.getText(findTestObject('Object Repository/Manage Data Source/input_SOAP Action_P4_SOAP_HOST_ACTION'))

    String_result7 = WebUI.getText(findTestObject('Object Repository/Manage Data Source/input_SOAP Method_P4_SOAP_METHOD'))

    String_result8 = WebUI.getText(findTestObject('Object Repository/Manage Data Source/select_User-Password'))

    String_result9 = WebUI.getText(findTestObject('Object Repository/Manage Data Source/input_Username_P4_DS_USERNAME'))

    WebUI.click(findTestObject('Object Repository/Manage Data Source/button_Cancel1'))
} else {
...
WebUI.sendKeys(findTestObject('Manage Data Source/Manage Datasource3'), Keys.chord(Keys.ARROW_DOWN))
