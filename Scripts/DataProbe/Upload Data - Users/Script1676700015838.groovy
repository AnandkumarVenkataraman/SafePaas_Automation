...
WebUI.verifyElementClickable(findTestObject('Object Repository/Upload Data/Page_AddEdit Objectset/td_Users'))

WebUI.verifyElementText(findTestObject('Object Repository/Upload Data/Page_AddEdit Objectset/td_Users'), 'Users')

WebUI.verifyElementClickable(findTestObject('Object Repository/Upload Data/Page_AddEdit Objectset/select_Attribute_KTLNAttributes-DTP701Entry_9d1214'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Upload Data/Page_AddEdit Objectset/select_Attribute_KTLNAttributes-DTP701Entry_9d1214'), 
    '349761', true)
...
WebUI.setText(findTestObject('Object Repository/Upload Data/Page_Manage Snapshot/input_(Value Required)_P37_NAME'), 'Users_KTLN_FEB17_V2')
...
WebUI.click(findTestObject('Object Repository/Upload Data/Page_Manage Snapshot/li_Users_KTLN'))
...
WebUI.uploadFile(findTestObject('Upload Data/Page_Manage Snapshot/input_(Value Required)_P37_FILE'), 'C:\\Users\\MARIAISABEL.BRUM\\Desktop\\XML\'s\\Users_KTLN.xml')
