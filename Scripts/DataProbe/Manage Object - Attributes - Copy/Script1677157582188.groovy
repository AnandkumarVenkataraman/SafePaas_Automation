...
String result = WebUI.getText(findTestObject('Object Repository/Other Objects/a_Attribute_KTLN'), FailureHandling.CONTINUE_ON_FAILURE)

if (result.equals('Attribute_KTLN')) {
    WebUI.click(findTestObject('Object Repository/Other Objects/a_Attribute_KTLN'))

    String result1 = WebUI.getText(findTestObject('Object Repository/Other Objects/input_Object Name_P10_OBJECT_NAME'))
