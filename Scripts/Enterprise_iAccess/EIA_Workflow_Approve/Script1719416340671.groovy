...
WebUI.setText(findTestObject('Object Repository/EIA_Workflow_Approve/Page_Review Access Request/textarea_Review Comments_P23_COMMENTS'), 
    'Approved level 1')
...
WebUI.click(findTestObject('Object Repository/EIA_Workflow_Approve/Page_Manage My Access/a_Start date'))

WebUI.click(findTestObject('Object Repository/EIA_Workflow_Approve/Page_Manage My Access/button_Documentation_a-Button a-IRR-button _ce8d41'))

WebUI.verifyElementText(findTestObject('Object Repository/EIA_Workflow_Approve/Page_Manage My Access/td_Time and Labor Manager_ViewAllTIME_AND_L_d21705'), 
    'Time and Labor Manager_ViewAll[TIME_AND_LABOR_MANAGER_VIEWALL_DATA]')

WebUI.verifyElementText(findTestObject('Object Repository/EIA_Workflow_Approve/Page_Manage My Access/a_Approved'), 'Approved')
