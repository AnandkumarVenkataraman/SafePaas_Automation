...
WebUI.verifyElementClickable(findTestObject('Escalation/Page_Manage Workflow/h2_Reminder sent successfully'))

WebUI.click(findTestObject('Escalation/Page_Manage Workflow/h2_Reminder sent successfully'))
