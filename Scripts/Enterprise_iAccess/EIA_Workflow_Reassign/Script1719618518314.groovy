...
WebUI.selectOptionByLabel(findTestObject('Object Repository/EIA_Reassign/Page_Manage Workflow/select_- Please select any -MC28967KATALON__7019c2'), 
    'MC28967', true)

WebUI.verifyElementClickable(findTestObject('Object Repository/EIA_Reassign/Page_Manage Workflow/button_New Approver_P35_NEW_APPROVER_lov_btn'))

WebUI.click(findTestObject('Object Repository/EIA_Reassign/Page_Manage Workflow/button_New Approver_P35_NEW_APPROVER_lov_btn'))

WebUI.setText(findTestObject('Object Repository/EIA_Reassign/Page_Manage Workflow/input_New Approver_a-PopupLOV-search apex-i_52c1ca'), 
    'ANANDK')

WebUI.sendKeys(findTestObject('Object Repository/EIA_Reassign/Page_Manage Workflow/input_New Approver_a-PopupLOV-search apex-i_52c1ca'), 
    Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('Object Repository/EIA_Reassign/Page_Manage Workflow/td_ANANDK'))

WebUI.click(findTestObject('Object Repository/EIA_Reassign/Page_Manage Workflow/button_Submit (1)'))

WebUI.verifyElementClickable(findTestObject('Object Repository/EIA_Reassign/Page_Manage Workflow/h2_Workflow reassigned'))

WebUI.click(findTestObject('Object Repository/EIA_Reassign/Page_Manage Workflow/button_Breadcrumbs_t-Button t-Button--noUI _fee11d'))
