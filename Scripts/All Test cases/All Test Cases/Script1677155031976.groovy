...
WebUI.callTestCase(findTestCase('Manage Company/Manage Company'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3)

WebUI.callTestCase(findTestCase('Manage Environment'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3)

WebUI.callTestCase(findTestCase('SafePaaS User Listing/SafePaaS User Listing'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3)

WebUI.callTestCase(findTestCase('SafePaaS Application Listing/SafePaaS Application Listing'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('DataProbe/Analytics1'), [:], FailureHandling.STOP_ON_FAILURE)
