...
WebUI.click(findTestObject('Object Repository/Debabrata/Page_Login/div_Logo_t-Form-inputContainer col col-null'))
...
WebUI.click(findTestObject('Object Repository/Debabrata/Page_Home/span_AccessPaaS'))
