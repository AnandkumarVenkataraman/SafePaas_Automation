...
WebUI.click(findTestObject('Object Repository/deba1/Page_Manage Rules/span_Filter'))
...
WebUI.verifyElementClickable(findTestObject('Object Repository/deba1/Page_Manage Rules/a_ALL CERP RULES'))

WebUI.click(findTestObject('Object Repository/deba1/Page_Manage Rules/a_ALL CERP RULES'))

WebUI.verifyElementClickable(findTestObject('Object Repository/deba1/Page_Manage Rules/a_AR_AdjustmentProfile'))

WebUI.click(findTestObject('Object Repository/deba1/Page_Manage Rules/a_AR_AdjustmentProfile'))

WebUI.verifyElementClickable(findTestObject('Object Repository/deba1/Page_Manage Rules/a_All'))

WebUI.click(findTestObject('Object Repository/deba1/Page_Manage Rules/a_All'))

WebUI.verifyElementClickable(findTestObject('Object Repository/deba1/Page_Manage Rules/a_ProcurementAgent'))

WebUI.click(findTestObject('Object Repository/deba1/Page_Manage Rules/a_ProcurementAgent'))

WebUI.click(findTestObject('Object Repository/deba1/Page_Manage Rules/input_Expression_p_ignore_10'))

WebUI.verifyElementClickable(findTestObject('Object Repository/deba1/Page_Manage Rules/button_Apply'))

WebUI.click(findTestObject('deba1/Page_Manage Rules/button_Apply - Copy (1)'))
...
WebUI.click(findTestObject('deba1/Page_Manage Rules/button_Apply - Copy - Copy'))
...
WebUI.click(findTestObject('deba1/Page_Manage Rules/button_Apply - Copy - Copy (1)'))

WebUI.verifyElementPresent(findTestObject('Object Repository/deba1/Page_Manage Rules/span_1 -                   15 of           _17b88d'), 
    0)

WebUI.delay(3)

WebUI.verifyElementClickable(findTestObject('Object Repository/deba1/Page_Manage Rules/button_All_a-Button a-IRR-button a-IRR-butt_d69c6b'))

WebUI.click(findTestObject('Object Repository/deba1/Page_Manage Rules/button_All_a-Button a-IRR-button a-IRR-butt_d69c6b'))

WebUI.verifyElementPresent(findTestObject('Object Repository/deba1/Page_Manage Rules/span_16 -                   30 of          _c7ad47'), 
    0)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/deba1/Page_Manage SOD Test/h2_Action Processed'), 0, FailureHandling.OPTIONAL)
