...
WebUI.verifyElementClickable(findTestObject('Object Repository/EIA/EIA_Setup/Page_Scope Roles/a_Scope Roles'))

WebUI.click(findTestObject('Object Repository/EIA/EIA_Setup/Page_Scope Roles/a_Scope Roles'))
