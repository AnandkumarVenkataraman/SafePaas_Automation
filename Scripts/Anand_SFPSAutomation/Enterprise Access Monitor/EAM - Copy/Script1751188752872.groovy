...
WebUI.click(findTestObject('Object Repository/Anand_SFPSAutomation/Page_Manage Violation/button_Request Name_P74_REQUEST_NAME_lov_btn (2)'))
...
//WebUI.navigateToUrl('https://us21n.safepaas.com/monitor/f?p=1000:101::::::')
//
//WebUI.click(findTestObject('Object Repository/Anand_SFPSAutomation/Page_Initiate Rules Review/a_Inbox_oj-datepicker-prev-icon oj-disabled_d9796f'))
//
//
//
//WebUI.click(findTestObject('Object Repository/Anand_SFPSAutomation/Page_Initiate Rules Review/div_Start Date_row'))
//
//WebUI.closeBrowser()
