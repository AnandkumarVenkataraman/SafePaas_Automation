...
WebUI.callTestCase(findTestCase('Anand_SFPSAutomation/Enterprise Access Monitor/SAP/2. Rules2/1. Rules'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Anand_SFPSAutomation/Enterprise Access Monitor/SAP/2. Rules2/2. Rules4'), [:], FailureHandling.STOP_ON_FAILURE)
