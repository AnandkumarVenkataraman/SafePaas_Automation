...
WebUI.selectOptionByLabel(findTestObject('Manage Violations/select_Select any OneKTLN_APRIL18_V3KTLN_AP_2323e8'), 'KTLN_MAY8_V1', 
...
WebUI.click(findTestObject('Manage Violations/a_Manage Violation'))
