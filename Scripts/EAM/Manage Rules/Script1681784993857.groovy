...
WebUI.click(findTestObject('Manage Rules/TreeView EAM'))

WebUI.click(findTestObject('Manage Rules/TreeView Define Scope'))

WebUI.click(findTestObject('Manage Rules/a_Manage Rules'))
