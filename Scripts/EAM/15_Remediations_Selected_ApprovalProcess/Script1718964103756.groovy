...
WebUI.setText(findTestObject('Object Repository/Inbox/Page_Login/input_P101_COMPANY (1)'), 'KAT')

WebUI.setText(findTestObject('Object Repository/Inbox/Page_Login/input_P101_USERNAME (1)'), 'KATALON_ADMIN')

WebUI.setEncryptedText(findTestObject('Object Repository/Inbox/Page_Login/input_P101_PASSWORD (1)'), 'Ioqy8emDrxi5mkiNQATzxQ==')

WebUI.click(findTestObject('Object Repository/Inbox/Page_Login/button_Login (1)'))

WebUI.verifyElementClickable(findTestObject('Object Repository/Inbox/Page_Home/span_a-TreeView-toggle (1)'))

WebUI.click(findTestObject('Object Repository/Inbox/Page_Home/span_a-TreeView-toggle (1)'))

WebUI.verifyElementClickable(findTestObject('Object Repository/Inbox/Page_Home/span_a-TreeView-toggle_1 (1)'))

WebUI.click(findTestObject('Object Repository/Inbox/Page_Home/span_a-TreeView-toggle_1 (1)'))

WebUI.verifyElementClickable(findTestObject('Object Repository/Inbox/Page_Home/span_a-TreeView-toggle_1_2 (1)'))

WebUI.click(findTestObject('Object Repository/Inbox/Page_Home/span_a-TreeView-toggle_1_2 (1)'))

WebUI.verifyElementClickable(findTestObject('Object Repository/deba/Filters/Page_Home/a_Manage Corrective Action - 925'))

WebUI.click(findTestObject('Object Repository/deba/Filters/Page_Home/a_Manage Corrective Action - 925'))
...
WebUI.scrollToElement(findTestObject('Object Repository/deba1/ManageCorrectiveActions_Selected/Page_Manage Corrective Action/td_In Progress'), 
...
WebUI.verifyElementClickable(findTestObject('Object Repository/deba1/ManageCorrectiveActions_Selected/Page_Home/Inbox button - New'), 
    FailureHandling.OPTIONAL)

WebUI.click(findTestObject('Object Repository/deba1/ManageCorrectiveActions_Selected/Page_Home/Inbox button - New'))

WebUI.verifyElementClickable(findTestObject('Object Repository/Inbox/Page_Home/button_Actions'))

WebUI.click(findTestObject('Object Repository/Inbox/Page_Home/button_Actions'))

WebUI.verifyElementClickable(findTestObject('Object Repository/Inbox/Page_Home/button_Filter'))

WebUI.click(findTestObject('Object Repository/Inbox/Page_Home/button_Filter'))

WebUI.verifyElementClickable(findTestObject('Object Repository/Inbox/Page_Home/select_PriorityMessage TypeRecipient RoleSu_c0d0b3'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Inbox/Page_Home/select_PriorityMessage TypeRecipient RoleSu_c0d0b3'), 
    'SUBJECT', true)

WebUI.verifyElementClickable(findTestObject('Object Repository/Inbox/Page_Home/select_is nullis not nulllikenot likeinnot _365127 (1)'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Inbox/Page_Home/select_is nullis not nulllikenot likeinnot _365127 (1)'), 
    'contains', true)

WebUI.verifyElementText(findTestObject('Object Repository/Inbox/Page_Home/input_Expression_p_ignore_10'), '')

WebUI.setText(findTestObject('Object Repository/Inbox/Page_Home/input_Expression_p_ignore_10'), 'The Manage Payables Activities')

WebUI.verifyElementClickable(findTestObject('Object Repository/Inbox/Page_Home/button_Apply (1)'))

WebUI.click(findTestObject('Object Repository/Inbox/Page_Home/button_Apply (1)'))

WebUI.verifyElementClickable(findTestObject('Object Repository/Inbox/Page_Home/a_The Manage Payables Activities vs. Approv_95a034'))

WebUI.click(findTestObject('Object Repository/Inbox/Page_Home/a_The Manage Payables Activities vs. Approv_95a034'))
...
WebUI.verifyElementClickable(findTestObject('Object Repository/deba1/ManageCorrectiveActions_Selected/Page_Home/a_Manage Corrective Action - New123'))

WebUI.click(findTestObject('Object Repository/deba1/ManageCorrectiveActions_Selected/Page_Home/a_Manage Corrective Action - New123'))
...
WebUI.scrollToElement(findTestObject('Object Repository/deba1/ManageCorrectiveActions_Selected/Page_Manage Corrective Action/span_1 -                    1'), 
    0, FailureHandling.OPTIONAL)
