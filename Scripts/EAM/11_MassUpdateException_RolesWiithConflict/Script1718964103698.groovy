...
WebUI.verifyElementClickable(findTestObject('deba1/ManageException_RolesWithConflict/Page_Manage Violation/button_Mass Update Exceptions - U30'))

WebUI.click(findTestObject('deba1/ManageException_RolesWithConflict/Page_Manage Violation/button_Mass Update Exceptions - U30'))

WebUI.scrollToElement(findTestObject('deba1/ManageException_RolesWithConflict/Page_Manage Violation/ScrolltoElement_Roleswith conflict_U40'), 
    0)
